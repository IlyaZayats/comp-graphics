...
void display() {
    ...
    glTranslatef(0.0f, -0.5f, -6.0f);  // Move right and into the screen
    ...
    glTranslatef(0,y+0.3,0.3*19);
    glColor3f(1,1,1);
    glTranslatef(1.2,0,-2.4);
    glutSolidTeapot(0.2);
    glTranslatef(0.8,0,0);
    glRotatef(90,1,0,0);
    glutSolidTorus(0.1,0.3,250,250);
...
//    glutSolidSphere(0.05,250,250);
//    glTranslatef(0.3f, 0,0.2);
//    glColor3f(1,0,0);
//    glutSolidSphere(0.2,250,250);
//    glColor3f(1,1,1);
//    glTranslatef(0,0,-0.2);
//    glutSolidSphere(0.05,250,250);
//    glTranslatef(-0.3, -0.3,0.7);
//
